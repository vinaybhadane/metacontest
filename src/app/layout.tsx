...
export const metadata: Metadata = {
  ...
  description:
    "Participate in META Contest on June 6, 2026. 50 MCQ questions covering GK, Tech, Aptitude & Current Affairs. Win up to ₹5,000. Open for all. Entry fee just ₹50.",
  keywords: [
    "META Contest",
  ...
  openGraph: {
    ...
    description:
      "India's most open online contest. Appear on June 6, 2026. Win prizes, earn your certificate. Open for everyone.",
  ...
  twitter: {
    ...
    description:
      "Join India's open online quiz on June 6, 2026. Win up to ₹5,000. Entry fee: ₹50.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
